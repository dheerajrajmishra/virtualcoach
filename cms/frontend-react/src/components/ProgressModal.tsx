...
const STEPS = [
  ...
  { key: 'TRANSLATING', label: 'AI Translation', description: 'Using Gemini to translate content into supported locales' },
  { key: 'GENERATING_AUDIO', label: 'Voice Synthesis', description: 'Generating high-quality audio with ElevenLabs' },
